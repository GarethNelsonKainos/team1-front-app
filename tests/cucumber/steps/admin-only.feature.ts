...
Given('that I am signed in a standard user', async function (this: PlaywrightWorld) {
...
When('I navigate to the {string} section', async function (this: PlaywrightWorld, url: string) {
  await this.page.goto(url);
});

Then('I should not see the {string} button', async function (this: PlaywrightWorld, buttonText: string) {
